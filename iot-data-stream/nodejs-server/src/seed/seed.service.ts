...
export default class SeedService {
    ...
    private randomInRange(range: [number, number] | undefined): number | null {
    ...
    private async generateClustersForLocation(locationId: number, city: string, clusterCount: number) {
