...
exports.ExerciseBuilderService = exports.INTEGRATED_PROFILES = exports.INDUSTRIAL_CITIES = void 0;
// 🌍 Catalogue des hubs majeurs de datacenters mondiaux
exports.INDUSTRIAL_CITIES = {
...
class ExerciseBuilderService {
    ...
    async buildSandbox(input) {
        ...
        for (const block of input.topology) {
            const cityConfig = exports.INDUSTRIAL_CITIES[block.city];
            const blueprint = exports.INTEGRATED_PROFILES[block.configProfile];
            if (!cityConfig)
        ...
        for (let hourOffset = totalHours; hourOffset >= 0; hourOffset--) {
            ...
            for (const server of servers) {
                ...
                for (const sensor of server.sensors) {
                    ...
                    if (type === "LOAD")
                        sensorValue = actualLoad;
                    else if (type === "CPU_TEMP")
                        sensorValue = cpuTemp;
                    else if (type === "TOTAL_POWER")
                        sensorValue = powerWatts;
                    else if (type === "FAN_SPEED_1" || type === "FAN_SPEED_2")
